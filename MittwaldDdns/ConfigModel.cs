...
{
    [JsonPropertyName("global_webhook")]
...
public sealed class EncryptedConfig
{
    ...
    public string Format { get; set; } = ConfigStore.EncryptedFormat;

    [JsonPropertyName("version")]
    public int Version { get; set; } = 1;

    [JsonPropertyName("algorithm")]
    public string Algorithm { get; set; } = ConfigStore.EncryptionAlgorithm;
